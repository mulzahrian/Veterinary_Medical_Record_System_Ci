          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5"><h5><?php echo $user ?> USER</h5></div>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5"><h5><?php echo $peternak ?> PETERNAK</h5></div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="#">
                <span class="float-left"></span>
                <span class="float-right">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5"><h5><?php echo $hewan ?> HEWAN TERNAK</h5></div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="#">
                <span class="float-left"></span>
                <span class="float-right">
...
<!--end of cardboard-->
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="assets/img/dokumentasi/one.png" class="d-block w-80" alt="...">
    </div>
    <div class="carousel-item">
      <img src="assets/img/dokumentasi/two.png" class="d-block w-80" alt="...">
    </div>
    <div class="carousel-item">
      <img src="assets/img/dokumentasi/three.png" class="d-block w-80" alt="...">
    </div>
  </div>
  </center>
...
<div>
  ...
  <div class="card-body">
    ...
    <p class="card-text">Mendorong peningkatan ketahanan pangan melalui pengendalian penyakit hewan menular, pengawasan kesehatan masyarakat veteriner dan penjaminan produk asal hewan yang Aman, Sehat, Utuh dan Halal (ASUH)  </p>
